...
global crop_size, upscale_factor, input_size, batch_size
crop_size = 300
upscale_factor = 3
...
print("\n\tPreprocesamiento del dataset terminado.")
...
def plot_results(img, prefix, title):
    ...
    plt.savefig("Salidas/"+str(prefix) + "-" + title + ".png")
